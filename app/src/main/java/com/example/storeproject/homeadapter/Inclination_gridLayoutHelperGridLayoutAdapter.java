...
public class Inclination_gridLayoutHelperGridLayoutAdapter extends DelegateAdapter.Adapter<Inclination_gridLayoutHelperGridLayoutAdapter.ViewHoldr> {
    private Context context;
    private GridLayoutHelper gridLayoutHelper;
    private ArrayList<HomeBean.DataBean.CategoryListBean> list;


    public Inclination_gridLayoutHelperGridLayoutAdapter(Context context, GridLayoutHelper gridLayoutHelper, ArrayList<HomeBean.DataBean.CategoryListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHoldr holder, int position) {
        HomeBean.DataBean.CategoryListBean.GoodsListBean bean = list.get(8).getGoodsList().get(position);
