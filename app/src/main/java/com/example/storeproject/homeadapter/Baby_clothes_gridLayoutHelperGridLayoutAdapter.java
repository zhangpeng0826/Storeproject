...
public class Baby_clothes_gridLayoutHelperGridLayoutAdapter extends DelegateAdapter.Adapter<Baby_clothes_gridLayoutHelperGridLayoutAdapter.ViewHoldr> {
    private Context context;
    private GridLayoutHelper gridLayoutHelper;
    private ArrayList<HomeBean.DataBean.CategoryListBean> list;


    public Baby_clothes_gridLayoutHelperGridLayoutAdapter(Context context, GridLayoutHelper gridLayoutHelper, ArrayList<HomeBean.DataBean.CategoryListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHoldr holder, int position) {
        HomeBean.DataBean.CategoryListBean.GoodsListBean bean = list.get(5).getGoodsList().get(position);
