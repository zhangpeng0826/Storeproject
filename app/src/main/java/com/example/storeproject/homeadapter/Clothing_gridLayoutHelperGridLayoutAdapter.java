...
public class Clothing_gridLayoutHelperGridLayoutAdapter extends DelegateAdapter.Adapter<Clothing_gridLayoutHelperGridLayoutAdapter.ViewHoldr> {
    private Context context;
    private GridLayoutHelper gridLayoutHelper;
    private ArrayList<HomeBean.DataBean.CategoryListBean> list;


    public Clothing_gridLayoutHelperGridLayoutAdapter(Context context, GridLayoutHelper gridLayoutHelper, ArrayList<HomeBean.DataBean.CategoryListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHoldr holder, int position) {
        HomeBean.DataBean.CategoryListBean.GoodsListBean bean = list.get(4).getGoodsList().get(position);
