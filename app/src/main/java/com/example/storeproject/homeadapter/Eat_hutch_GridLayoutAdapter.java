...
public class Eat_hutch_GridLayoutAdapter extends DelegateAdapter.Adapter<Eat_hutch_GridLayoutAdapter.ViewHoldr> {
    private Context context;
    private GridLayoutHelper gridLayoutHelper;
    private ArrayList<HomeBean.DataBean.CategoryListBean> list;


    public Eat_hutch_GridLayoutAdapter(Context context, GridLayoutHelper gridLayoutHelper, ArrayList<HomeBean.DataBean.CategoryListBean> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHoldr holder, int position) {
        HomeBean.DataBean.CategoryListBean.GoodsListBean bean = list.get(1).getGoodsList().get(position);
